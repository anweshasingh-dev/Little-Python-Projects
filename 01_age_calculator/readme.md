...
* **Minimum Value:** January 1, 1900 (`centuary_ago`) — *Ensures a wide historical range for older generations.*
* **Maximum Value:** Current Date (`today`) — *Prevents users from selecting a birth date in the future.*
